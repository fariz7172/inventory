...
@section('header', 'Transfer Stock')
@section('subheader', 'Move items from Warehouse to Outlet')
...
@section('content')
    ...
    <div class="max-w-3xl">
        <form action="{{ route('inventory.storeTransfer') }}" method="POST" class="neumorphic p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-sm font-bold mb-2 ml-1 text-gray-700">
                        <span class="text-blue-600">From:</span> Warehouse (Source)
                    </label>
                    <div class="neumorphic-inset">
                ...
                <div>
                    <label class="block text-sm font-bold mb-2 ml-1 text-gray-700">
                        <span class="text-purple-600">To:</span> Outlet (Destination)
                    </label>
                    <div class="neumorphic-inset">
            ...
            <div>
                ...
                <div class="neumorphic-inset">
                    <textarea name="serial_numbers_input" class="form-input" rows="4" placeholder="Scan barcodes of items to transfer (one per line).">{{ old('serial_numbers_input') }}</textarea>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="neumorphic-inset">
                        <input type="text" name="reference_code" class="form-input" placeholder="e.g. TRF-001" value="{{ old('reference_code', $referenceCode ?? '') }}" readonly>
                    </div>
                </div>
                <div>
            ...
            <div class="pt-4">
                <button type="submit" class="neumorphic-btn w-full py-3 text-purple-600 font-bold hover:text-purple-700">
                    Submit Transfer
                </button>
            </div>
        </form>
